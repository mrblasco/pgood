...
```{r}
knitr::read_chunk("R/methods.R")
```

```{r methods_common_files}
```
...
```{r figure_timeline, fig.width=9, fig.height=4, fig.cap="Timeline of the innovation contest\\label{timeline}"}
```
