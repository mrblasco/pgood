...
Employees divide their time between production tasks tied to pay and promotion and organizational improvements ---solving common problems, innovating. As both kinds of activities are important for the operations of an organization, mangers often face a problem of encouraging work in one without lowering efforts in the other. Financial incentives alone are not sufficient. 


Employees divide their time between production tasks and organizational improvements. For example, xxxx. These forms of employee-driven improvements are important for the operations of an organization. 

Literature suggesting that agents work harder if they believe in the mission of the organization. 


Organizations, both for-profit and not-for-profit, have embraced the notion
of having employees working on organizational
.Mission statements are seen as a way to clarify ðand
...
<!-- 
, while work in production tasks can be tied to pay and promotion, improvement work generates benefits for the organization as a whole, xxxx tempted to free-ride on the efforts of others.  
 -->

<!-- 
improvement work together are essential for the operations of any organization, incentives to perform one or the other can be very different. As effort in production tasks is easy to measure, certain, and excludible (i.e., xxxx), production work is often tied to pay and promotion. On the contrary, effort in organizational improvements is difficult to measure, uncertain in its outcomes, and non-rival --- i.e., benefits the organization as a whole, thereby conventional incentives like bonuses or pay-for-performance schemes do not function well and may lead to suboptimal results. 
 -->

<!-- 
This dilemma leads to two key issues in the analysis of incentives inside organizations. First, workers may direct time and effort towards the rewarded tasks at the expense of the less-remunerative improvement work [@holmstrom1991multitask; @hellmann2011incentives; @manso2011motivating]. Second, given the non-rival nature of improvement work (i.e., work that benefits the organization as a whole), workers may be tempted to free-ride on the efforts of others, thus deferring work on these activities.
 -->


<!-- 
Employees divide their time between production tasks tied to pay and promotion and organizational improvements without explicit compensation. This dilemma leads to two key issues in the analysis of incentives inside organizations. First, workers may direct time and effort towards the rewarded tasks at the expense of the less-remunerative improvement work [@holmstrom1991multitask; @hellmann2011incentives; @manso2011motivating]. Second, given the non-rival nature of improvement work (i.e., work that benefits the organization as a whole), workers may be tempted to free-ride on the efforts of others, thus deferring work on these activities.
 -->

An organizational contest that seeks contribution of public goods (e.g., organizational improvement opportunities) may be a proper way to remedy the incentives. Inducement prizes are indeed effective compensation schemes for tasks that are less-contractible or with uncertain outcomes [@lazear1981rank; @green1983comparison; @mary1984economic among others] where it is difficult to assess (and tie rewards to) the absolute value of contributions. In addition, when the contest consists in contributing to public goods, the attempts made by one contestants exert a negative externality on the others --i.e., reduces their odds of winning--- that can mitigate, or even eliminate, the incentive to free ride [@morgan2000financing].

Even so, the design of an effective system of rewards that max xxxx can be quite challenging in practice. There are essentially three problems. First, the mitigating effect on free-riding, for instance, goes away when the rewards are proportional to individual efforts [@morgan2000financing], a situation that is difficult to control in settings where both pecuniary and non-pecuniary rewards are present (e.g., the reputation from winning can be larger when the win is outstanding). Second, when the contestants expect gains from the participation of others, the commonality of interest may create incentives for everyone to shirk [@drago1988incentive]. Third, sometimes complications could also arise, somewhat paradoxically, from the employees' intrinsic motivations towards the organization, also called pro-social vertical preferences [xxxx]. If employees have such preferences, they are willing to volunteer effort when the contest aim matches their preferences, as discussed by @besley2005competition, @prendergast2007motivation, @delfgaauw2008incentives among others. According to this perspective, announcing a competition for prizes can weaken their intrinsic motivations [@reeve1996elements; @frey1997not]. 

Additional problems are associated with incentives to sort into the contest like Participation in a contest can depend on inclinations towards competition or risk, potentially promoting differences xxx e.g., men and women @niederle2007women; @croson2009gender]. It romoting unethical behavior like chearing or sabotaging the contest [@lazear1989pay; @charness2013dark]; weakening intrinsic motivations [@reeve1996elements; @frey1997not]; and even hurting the creativity of innovative work [@erat2015incentives].


The externalities that arise in organizational contests can hence remedy the incentives, but at the same time can let the contest fail leading to sub-optimal outcomes.
...
The subject pool consisted of over 1,200 staff members of the Heart Center including physicians, nurses, and administrative staff (the entire population). Our main intervention involved altering the content of solicitation: in the PRIZE treatment, the solicitation nudged employees to participate to win an iPad mini; in the FUND treatment, the solicitation nudged employees to participate to win $20,000 towards implementation of the proposal (the submitters would not receive this money for personal use); in the remaining two treatments, we emphasized the opportunity to improve the health care of the patients (PCARE) or the workplace (WPLACE). We randomly assigned each Heart Center staff to receive one of the four solicitations. 
